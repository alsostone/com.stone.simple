...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static NativeList<MotionIndexAndWeight> GetBlendTree2DCurrentMotions(ref MotionBlob mb, in NativeArray<AnimatorControllerParameterComponent> runtimeParams, ScriptedAnimator.BlendTree2DType btType)
	{
		...
		{
			ScriptedAnimator.BlendTree2DType.SimpleDirectional => ScriptedAnimator.ComputeBlendTree2DSimpleDirectional(bttSpan, pt),
			ScriptedAnimator.BlendTree2DType.FreeformCartesian => ScriptedAnimator.ComputeBlendTree2DFreeformCartesian(bttSpan, pt),
			ScriptedAnimator.BlendTree2DType.FreeformDirectional => ScriptedAnimator.ComputeBlendTree2DFreeformDirectional(bttSpan, pt),
			_ => default
		};
		return rv;
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static NativeList<MotionIndexAndWeight> GetBlendTree1DCurrentMotions(ref MotionBlob mb, in NativeArray<AnimatorControllerParameterComponent> runtimeParams)
	{
		...
		var rv = ScriptedAnimator.ComputeBlendTree1D(bttSpan, blendTreeParameter.FloatValue);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	)
	{
		...
		case MotionBlob.Type.AnimationClip:
			...
			animationDatabase.TryGetValue(animationHash, out var animBlob);
		#if ENABLE_UNITY_COLLECTIONS_CHECKS
			var isBlobValid = BlobDatabaseSingleton.IsBlobValid(animBlob);
			if (!isBlobValid)
				throw new InvalidOperationException($"Animation blob asset '{animationHash}' is corrupted. It was likely a part of the subscene data and unloaded.");
		#endif
		...
		case MotionBlob.Type.BlendTree2DSimpleDirectional:
			blendTreeMotionsAndWeights = GetBlendTree2DCurrentMotions(ref mb, runtimeParams, ScriptedAnimator.BlendTree2DType.SimpleDirectional);
			break;
		case MotionBlob.Type.BlendTree2DFreeformCartesian:
			blendTreeMotionsAndWeights = GetBlendTree2DCurrentMotions(ref mb, runtimeParams, ScriptedAnimator.BlendTree2DType.FreeformCartesian);
			break;
		case MotionBlob.Type.BlendTree2DFreeformDirectional:
			blendTreeMotionsAndWeights = GetBlendTree2DCurrentMotions(ref mb, runtimeParams, ScriptedAnimator.BlendTree2DType.FreeformDirectional);
			break;
		default:
