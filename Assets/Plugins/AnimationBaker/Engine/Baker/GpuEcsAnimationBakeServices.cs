...
using AnimationBaker.AnimatorSystem;
using AnimationBaker.Data;
using Unity.Collections;
using Unity.Mathematics;
using UnityEditor;
using UnityEngine;

namespace AnimationBaker.Baker
{
    public static class GpuEcsAnimationBakerServices
    {
        ...
        private const string enumFileTemplate = "namespace AnimationBaker.AnimatorSystem\n"
                                                + "{\n"
        ...
        private const string behaviourFileTemplate = "namespace AnimationBaker.AnimatorSystem\n"
                                                + "{\n"
